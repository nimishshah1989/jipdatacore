...
class DeEquityTechnicalDailyV2(Base):
    ...
    beta_nifty: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    ...
    # Risk — multi-year windows (GAP-05)
    sharpe_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    sharpe_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    sortino_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    sortino_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    calmar_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    calmar_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    max_drawdown_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    max_drawdown_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    volatility_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    volatility_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    beta_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    beta_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    information_ratio_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    information_ratio_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    treynor_1y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    treynor_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    treynor_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    downside_risk_1y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    downside_risk_3y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
    downside_risk_5y: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 4), nullable=True)
