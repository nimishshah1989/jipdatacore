...
TABLE_SPECS: list[TableSpec] = [
    ...
    TableSpec("de_fo_ban_list", "fo_ban_list", "eod", "33 18 * * 1-5", "business_date", "equity", "P1", 24, 4),
    TableSpec("de_participant_oi", "participant_oi", "eod", "33 18 * * 1-5", "trade_date", "equity", "P1", 24, 4),
    ...
    # ── ETF ──
    TableSpec("de_etf_ohlcv", "etf_prices", "eod", "33 18 * * 1-5", "date", "etf", "P1", 24, 4),
    ...
    # ── Macro (RBI / FBIL) ──
    TableSpec("de_gsec_yield", "gsec_yields", "eod", "33 18 * * 1-5", "yield_date", "macro", "P2", 48, 12),
    ...
    TableSpec("de_bulk_block_deals", "bulk_block_deals", "eod", "33 18 * * 1-5", "deal_date", "qualitative", "P1", 24, 4),
    # ── Qualitative (RSS + Goldilocks) ──
    TableSpec("de_qual_documents", "qualitative_rss", "eod", "33 18 * * 1-5", "created_at", "qualitative", "P2", 24, 6),
